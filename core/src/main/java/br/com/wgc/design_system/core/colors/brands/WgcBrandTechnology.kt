...
/**
 * Cores de marcas de Tecnologia.
 */
object WgcBrandTechnology {
    // Tassel (Minimalist Multi-brand E-commerce)
    ...
    val curatedMarketBackground = android.graphics.Color.WHITE
    ...
    // Shopper (Emerald Green Modern E-commerce)
    ...
    val megaStorerBackground = android.graphics.Color.WHITE
    ...
    // NexKart (Royal Blue Premium E-commerce)
    ...
    val gadgetShopBackground = android.graphics.Color.WHITE
    ...
    // Shopease (Sunset Orange E-commerce UI Kit)
    ...
    val quickShopBackground = android.graphics.Color.WHITE
