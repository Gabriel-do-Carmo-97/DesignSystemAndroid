...
/**
 * Cores de marcas de Fashion.
 */
object WgcBrandFashion {
    // MegaStore (Fashion Store)
    ...
    val apparelBackground = android.graphics.Color.WHITE
    ...
    val boutiqueBackground = android.graphics.Color.WHITE
