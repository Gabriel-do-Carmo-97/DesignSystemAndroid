...
object WgcBrandGrocery {
    ...
    // Premium Grocery
    val premiumGroceryGreen = "#006837".toColorInt()
    val premiumGroceryGreenDark = "#004D26".toColorInt()
    val premiumGroceryGreenLight = "#E8F5E9".toColorInt()
    val premiumGroceryGold = "#C5A059".toColorInt()
    val premiumGroceryGoldDark = "#9E7D3B".toColorInt()
    val premiumGroceryGoldLight = "#FDF8ED".toColorInt()
    val premiumGroceryWineRed = "#8E1B32".toColorInt()
    val premiumGroceryWineRedDark = "#630E20".toColorInt()
    val premiumGroceryWineRedLight = "#F9EBEF".toColorInt()
    val premiumGroceryOrangeOrganic = "#E67E22".toColorInt()
    val premiumGroceryOrangeOrganicLight = "#FDF2E9".toColorInt()
    val premiumGroceryBackground = "#FBFBF8".toColorInt()
    val premiumGrocerySurface = android.graphics.Color.WHITE
