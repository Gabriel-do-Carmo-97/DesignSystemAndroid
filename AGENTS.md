...
| **`ds-navigation-flows`** | [`agents/ds-templates-agent.md`](./agents/ds-templates-agent.md) | `:ds-navigation-flows` | Orquestra grafos e fluxos de navegação desacoplados (Auth, Checkout, Onboarding) com type-safety e slots customizáveis. |
