package br.com.wgc.ds_templates.screens.organizze.model
...
object OrganizzeMockData {
    val accounts = listOf(
        OrganizzeAccount(
            ...
            type = "Conta Corrente",
            balance = "R$ 9.420,00",
            color = WgcCoreDsColors.organizzeCardNubank
        ),
        OrganizzeAccount(
            id = "2",
            name = "Itaú Uniclass",
            type = "Conta Salário",
            balance = "R$ 4.880,00",
            color = WgcCoreDsColors.organizzeCardItau
        ),
        OrganizzeAccount(
            id = "3",
            ...
            balance = "R$ 550,00",
            color = WgcCoreDsColors.organizzePrimary
        )
    )
    ...
    val creditCards = listOf(
        ...
        OrganizzeCreditCard(
            ...
            color = WgcCoreDsColors.organizzeCardInter,
            usageProgress = 0.024f
        )
    )

    val categories = listOf(
        OrganizzeCategoryItem("cat1", "Alimentação", Icons.Default.Fastfood, WgcCoreDsColors.shopEasePrimary, "R$ 1.500,00", "R$ 1.120,00", 0.74f),
        OrganizzeCategoryItem("cat2", "Transporte", Icons.Default.DirectionsCar, WgcCoreDsColors.organizzeTransferBlue, "R$ 800,00", "R$ 540,00", 0.67f),
        OrganizzeCategoryItem("cat3", "Moradia", Icons.Default.Home, WgcCoreDsColors.organizzeWarningYellow, "R$ 2.200,00", "R$ 2.200,00", 1.0f),
        OrganizzeCategoryItem("cat4", "Saúde", Icons.Default.LocalHospital, WgcCoreDsColors.organizzeExpenseRed, "R$ 600,00", "R$ 280,00", 0.46f),
        OrganizzeCategoryItem("cat5", "Compras", Icons.Default.ShoppingBag, WgcCoreDsColors.organizzeCardNubank, "R$ 900,00", "R$ 680,00", 0.75f),
        OrganizzeCategoryItem("cat6", "Educação", Icons.Default.School, WgcCoreDsColors.organizzePrimaryDark, "R$ 500,00", "R$ 350,00", 0.70f),
        OrganizzeCategoryItem("cat7", "Salário", Icons.Default.Payments, WgcCoreDsColors.organizzeIncomeGreen),
        OrganizzeCategoryItem("cat8", "Investimentos", Icons.Default.Work, WgcCoreDsColors.organizzePrimary)
    )
    ...
    val recentTransactions = listOf(
        OrganizzeTransactionItemModel(
            ...
            accountOrCard = "Nubank Ultravioleta",
            amount = "R$ 324,80",
        ...
        OrganizzeTransactionItemModel(
            ...
            color = WgcCoreDsColors.organizzeIncomeGreen
        ),
        OrganizzeTransactionItemModel(
            id = "t3",
            ...
            color = WgcCoreDsColors.organizzeTransferBlue
        ),
        OrganizzeTransactionItemModel(
            id = "t4",
            ...
            color = WgcCoreDsColors.organizzeExpenseRed
        ),
        OrganizzeTransactionItemModel(
            id = "t5",
            title = "Transferência para NuConta",
            category = "Transferência",
            accountOrCard = "Itaú -> Nubank",
            amount = "R$ 1.500,00",
