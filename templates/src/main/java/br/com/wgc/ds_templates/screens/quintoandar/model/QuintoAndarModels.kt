package br.com.wgc.ds_templates.screens.quintoandar.model

import br.com.wgc.design_system.components.fields.WgcQuintoAndarContractType

/**
 * Modelo representativo de um imóvel do QuintoAndar.
 */
data class QuintoAndarPropertyModel(
    val id: String,
    val title: String,
 ...
 */
data class QuintoAndarVisitModel(
    val id: String,
 ...
 */
data class QuintoAndarFilterState(
    val contractType: WgcQuintoAndarContractType = WgcQuintoAndarContractType.Rent,
...
/**
 * Dados de amostra oficiais para previews e demonstrações QuintoAndar.
 */
object QuintoAndarMockData {
    val properties: List<QuintoAndarPropertyModel> = listOf(
        QuintoAndarPropertyModel(
            id = "qa-prop-1",
    ...
    val visits: List<QuintoAndarVisitModel> = listOf(
        QuintoAndarVisitModel(
            id = "visit-1",
    ...
    val sampleDetailProperty: QuintoAndarPropertyModel = properties[0]
}
