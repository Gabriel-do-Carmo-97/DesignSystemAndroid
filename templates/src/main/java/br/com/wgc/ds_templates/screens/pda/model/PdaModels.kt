package br.com.wgc.ds_templates.screens.pda.model

/**
 * Modelo de dados de um produto do Pão de Açúcar Mais.
 */
...
/**
 * Modelo de cupom de desconto personalizado "Meu Desconto Pão de Açúcar".
 */
...
/**
 * Dados simulados e curadoria gourmet para os templates do Pão de Açúcar Mais.
 */
object PdaMockData {
    ...
    val defaultUser = PdaUserProfile(
        ...
        selectedStore = "Pão de Açúcar - Jardins / Alameda Ministro Rocha",
