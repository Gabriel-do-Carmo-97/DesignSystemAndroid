package br.com.wgc.ds_templates.screens.vivareal.model

import br.com.wgc.design_system.components.fields.WgcVivaRealPurpose

/**
 * Modelo de Imóvel anunciado no portal Viva Real.
 */
data class VivaRealPropertyModel(
    val id: String,
    val code: String,
    val title: String,
...
/**
 * Dados de amostra para testes e previews do ecossistema Viva Real.
 */
object VivaRealMockData {
    val properties: List<VivaRealPropertyModel> = listOf(
        VivaRealPropertyModel(
            id = "vr-prop-1",
            code = "VR-94812",
    ...
    val sampleProperty: VivaRealPropertyModel = properties[0]
}
