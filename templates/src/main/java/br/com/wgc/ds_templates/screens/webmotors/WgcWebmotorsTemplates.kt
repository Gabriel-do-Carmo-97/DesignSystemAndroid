...
@Composable
fun WgcWebmotorsHomeTemplate(
    vehicles: List<VehicleItem> = WebmotorsMockData.sampleVehicles,
    ...
    LazyColumn(
        ...
        item {
            Card(
                ...
                colors = CardDefaults.cardColors(containerColor = Color(WgcCoreDsColors.webmotorsRed))
            ) {
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(WgcCoreDsSpacing.md16.dp)) {
                    ...
                    Row(
                        ...
                        Text(text = "R$ " + String.format("%.2f", car.price), fontWeight = FontWeight.Bold, fontSize = 18.sp, color = Color(WgcCoreDsColors.webmotorsRed))
...
@Composable
fun WgcWebmotorsDetailTemplate(
    car: VehicleItem = WebmotorsMockData.sampleVehicles.first(),
    ...
    Column(modifier = Modifier.fillMaxSize().background(Color(WgcCoreDsColors.grey50)).padding(WgcCoreDsSpacing.md16.dp)) {
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(WgcCoreDsSpacing.md16.dp), verticalArrangement = Arrangement.spacedBy(WgcCoreDsSpacing.xs8.dp)) {
                ...
                Text(text = "Preço Anunciado: R$ " + String.format("%.2f", car.price), fontWeight = FontWeight.Bold, fontSize = 18.sp, color = Color(WgcCoreDsColors.webmotorsRed))
...
@Composable
fun WgcWebmotorsFinancingTemplate(
    ...
    Column(modifier = Modifier.fillMaxSize().background(Color(WgcCoreDsColors.grey50)).padding(WgcCoreDsSpacing.md16.dp)) {
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(WgcCoreDsSpacing.md16.dp), verticalArrangement = Arrangement.spacedBy(WgcCoreDsSpacing.xs8.dp)) {
                ...
                Text(text = "Saldo em: 48x de R$ " + String.format("%.2f", monthlyPayment), fontWeight = FontWeight.Bold, fontSize = 16.sp, color = Color(WgcCoreDsColors.webmotorsRed))
...
@Composable
fun WgcWebmotorsProfileTemplate() {
    Column(modifier = Modifier.fillMaxSize().background(Color(WgcCoreDsColors.grey50)).padding(WgcCoreDsSpacing.md16.dp)) {
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(WgcCoreDsSpacing.md16.dp), verticalArrangement = Arrangement.spacedBy(WgcCoreDsSpacing.xs8.dp)) {
                ...
                Text(text = "Propostas Recebidas: 4 novas mensagens", fontSize = 14.sp, color = Color(WgcCoreDsColors.webmotorsRed), fontWeight = FontWeight.SemiBold)
            }
        }
    }
}
