...
import br.com.wgc.design_system.components.cards.WgcFintechSavingsBoxCard

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun WgcNeobankInvestTemplate(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            items(FintechNeobankMockData.sampleCaixinhas) { caixinha ->
                WgcFintechSavingsBoxCard(
                    title = caixinha.name,
